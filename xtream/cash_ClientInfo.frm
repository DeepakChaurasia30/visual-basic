VERSION 5.00
Begin VB.Form cash_ClientInfo 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cash Client Info"
   ClientHeight    =   2910
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7380
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   390
      Left            =   6000
      Picture         =   "cash_ClientInfo.frx":058A
      TabIndex        =   12
      Top             =   2220
      Width           =   675
   End
   ...
   Begin VB.CommandButton Command6 
      ...
      Height          =   390
      Left            =   2640
      Picture         =   "cash_ClientInfo.frx":09CC
      TabIndex        =   6
      Top             =   2220
      Width           =   675
   End
   Begin VB.CommandButton Command7 
      ...
      Height          =   390
      Left            =   3300
      Picture         =   "cash_ClientInfo.frx":0E0E
      TabIndex        =   5
      Top             =   2220
      Width           =   675
   End
   Begin VB.CommandButton Command8 
      ...
      Height          =   390
      Left            =   3960
      Picture         =   "cash_ClientInfo.frx":1250
      TabIndex        =   4
      Top             =   2220
      Width           =   675
   End
   Begin VB.CommandButton Command9 
      ...
      Height          =   390
      Left            =   4620
      Picture         =   "cash_ClientInfo.frx":1692
      TabIndex        =   3
      Top             =   2220
      Width           =   675
   End
   Begin VB.CommandButton Command11 
      ...
      Height          =   390
      Left            =   5310
      Picture         =   "cash_ClientInfo.frx":1AD4
      TabIndex        =   2
      Top             =   2220
      Width           =   675
   End
   ...
   End
End
Attribute VB_Name = "cash_ClientInfo"
...
'      Used Table : cash_client_master
'open the cash_client_master
...
Private Sub Form_Load()
    ...
    RS1.Open "select * from cash_client_master order by client_name ", Cn, adOpenDynamic, adLockOptimistic
