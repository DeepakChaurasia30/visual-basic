...
dbE.CompactDatabase App.path & "\donttouch.mdb", App.path & "\RepairedDB", , , ";pwd=xtream@30"
'>>> delete old database
Kill App.path & "\donttouch.mdb"
'>>> rename the new database to old database
Name App.path & "\repairedDB.mdb" As App.path & "\donttouch.mdb"
'>>> open connection
Call OpenCon
End Sub
